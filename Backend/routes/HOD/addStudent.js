...
Router.post('/', function (req, res) {
    ...
    var values = [Email, Password, PhoneNo, Name, Designation, Registration]
    db.query('INSERT INTO `users`(`Email`, `Password`, `PhoneNo`, `Name`, `Designation`, `RegistrationNo`) VALUES (?)', [values], function (err, result) 
    {
        if (err) {
            res.json({
                success: false,
