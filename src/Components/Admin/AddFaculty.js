...
export default class AddFaculty extends Component 
{
    ...
    try {
        ...
        var res = await axios({
            method: 'post',
            url: 'http://localhost:3306/AddFacultyADMIN',
            data: {
                Email: Email,
                Password: Password,
                PhoneNo: PhoneNo,
                ...
                <hr></hr>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="form-group">
                            <div>
                            <div className="container-fluid" style={mystyle}><Link to="/Admin/Faculty">
                                    <input style={mystyle} type="submit" defaultValue="Create" onClick={() => this.CreateFacultyUser()} className="btn btn-primary" /></Link>
                                </div>
                            </div>
                            </div>
                        </div>
