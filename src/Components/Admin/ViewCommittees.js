...
export default class ViewCommittees extends Component {
    ...
    async viewCommitteeDetails(idCommittee) {
        await axios.get('http://localhost:3306/viewCommitteesADMIN/details', { headers: {
    ...
    deleteRow(idCommittee) {
        Swal.fire({
            ...
            preConfirm: async () => {
                await axios.put(`http://localhost:3306/viewCommitteesADMIN/delCommittee`, { id: idCommittee })
                .then(res =>{
