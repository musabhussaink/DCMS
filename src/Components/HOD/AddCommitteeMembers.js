...
export default class AddCommitteeMembers extends Component 
{
    ...
    async getCommitteeOptions(){
        const res = await axios.get('http://localhost:3306/addCommitteeMemberHOD/committeelist')
        const data = res.data
    ...
    async getUserOptions(){
        const res = await axios.get('http://localhost:3306/addCommitteeMemberHOD/userlist')
        const data = res.data
    ...
    async getRoleOptions(){
        const res = await axios.get('http://localhost:3306/addCommitteeMemberHOD/roleslist')
        const data = res.data
    ...
    renderRedirect = () => {
        if (this.state.redirect) {
            return <Redirect to='/HOD/ViewCommitteeMembers' />
        }
    }
    ...
    try {
        ...
        var res = await axios({
            method: 'post',
            url: 'http://localhost:3306/addCommitteeMemberHOD',
            data: {
                ...
                <div className="row">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="form-group">
                            <div>
                            <div className="container-fluid" style={mystyle}><Link to="/HOD/ViewCommitteeMembers">
